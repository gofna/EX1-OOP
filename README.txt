...
Monom classthat implement the interface "function" and represents a simple Monom of shape ax^b, where 'a' is a real number and 'b' is a positive integer. any different shape (such as: a*x^b , ax^^, axx^b, negative or decimal b or space between the values) will cause to exception. The class implements function and support simple operations as: construction, value at x, derivative, add and multiply.
